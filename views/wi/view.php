...
<div class="giiant-crud wi-view">
    ...
    'attributes' => [
		...
		[
			'attribute'=>'wi_file',
            'format'=>'raw',
			'visible' => $model->wi_status == 'CLOSE' || in_array(Yii::$app->user->identity->role_id, Yii::$app->params['roleid_superadmin']) ? true : false,
			'value' => Html::a($model->wi_filename, Yii::$app->request->hostInfo . '/workflow/' . $model->wi_file),
