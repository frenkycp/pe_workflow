...
$this->title = 'Doc Type ' . $model->doc_type_id;
...
?>
<div class="giiant-crud doc-type-view">

    <!-- menu buttons -->
    <p class='pull-left'>
        <?= Html::a('<span class="glyphicon glyphicon-pencil"></span> ' . 'Edit', ['update', 'doc_type_id' => $model->doc_type_id],['class' => 'btn btn-info']) ?>
        <?= Html::a('<span class="glyphicon glyphicon-plus"></span> ' . 'New', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <p class="pull-right">
        <?= Html::a('<span class="glyphicon glyphicon-list"></span> ' . 'List DocTypes', ['index'], ['class'=>'btn btn-default']) ?>
    </p>
    ...
    <?php $this->beginBlock('app\models\DocType'); ?>
    ...
    <?= Html::a('<span class="glyphicon glyphicon-trash"></span> ' . 'Delete', ['delete', 'doc_type_id' => $model->doc_type_id],
    [
...
<div style='position: relative'><div style='position:absolute; right: 0px; top 0px;'>
  ...
  <?= Html::a(
            ...
            ['wi-masterlist/create', 'WiMasterlist' => ['doc_type' => $model->doc_type_id]],
...
<?php $this->endBlock() ?>
    ...
    <?= Tabs::widget(
                 [
                     ...
                     'encodeLabels' => false,
                     'items' => [ [
    'label'   => '<b class=""># '.$model->doc_type_id.'</b>',
    'content' => $this->blocks['app\models\DocType'],
    'active'  => true,
],[
